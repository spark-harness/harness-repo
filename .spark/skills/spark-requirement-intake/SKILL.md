...
If approved, continue to `spark-context-scan` or `spark-requirement-authoring` depending on how much context is already known. If not approved, revise the brief before any production work.
